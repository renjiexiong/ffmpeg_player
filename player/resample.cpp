...
bool Resample::Open(AVCodecContext *para,int channel,bool isClearPara)
{
    ...
    if(1==m_channel)
    {
        ...
        actx = swr_alloc_set_opts(actx,
            av_get_default_channel_layout(1),	//输出格式
            ...
            (AVSampleFormat)para->sample_fmt,
            para->sample_rate,
            0, 0
        );
    }
...
int Resample::RResample(AVFrame *indata, unsigned char *d)
{
    if (!indata) return 0;
    if (!d)
    {
