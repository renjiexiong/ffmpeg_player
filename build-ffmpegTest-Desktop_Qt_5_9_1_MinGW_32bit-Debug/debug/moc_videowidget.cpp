...
#include "../../ffmpegTest/videowidget.h"
...
void *VideoWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QOpenGLFunctions"))
        return static_cast< QOpenGLFunctions*>(const_cast< VideoWidget*>(this));
    if (!strcmp(_clname, "IVideoCall"))
        return static_cast< IVideoCall*>(const_cast< VideoWidget*>(this));
