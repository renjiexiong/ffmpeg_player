...
#include "../../ffmpegTest/audiothread.h"
...
const QMetaObject AudioThread::staticMetaObject = {
    { &DecodeThread::staticMetaObject, qt_meta_stringdata_AudioThread.data,
      qt_meta_data_AudioThread,  qt_static_metacall, nullptr, nullptr}
};
...
void *AudioThread::qt_metacast(const char *_clname)
{
    ...
    return DecodeThread::qt_metacast(_clname);
}

int AudioThread::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = DecodeThread::qt_metacall(_c, _id, _a);
    return _id;
}
QT_WARNING_POP
